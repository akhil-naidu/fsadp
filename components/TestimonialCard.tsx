...
export function TestimonialCard() {
  return (
    <Card className='flex-1 p-6 bg-gradient-to-br from-gray-800 to-purple-900 text-white border border-purple-600/20 lg:flex lg:flex-col lg:justify-center lg:h-full shadow-xl'>
      ...
      <p className='text-gray-300'>
        &quot;FSADP&apos;s practical approach to learning fullstack development
        was exactly what I needed. The project-based curriculum and mentorship
        from Akhil sir helped me transition from a junior developer to a
        confident fullstack engineer.&quot;
      </p>
      <div className='mt-6'>
