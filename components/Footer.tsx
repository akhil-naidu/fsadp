...
export function Footer() {
  return (
    <footer className="border-t border-purple-600/20 bg-gray-900/90 backdrop-blur-sm">
        ...
        <div className="flex flex-col space-y-8 md:flex-row md:justify-between md:space-y-0">
          <div className="flex flex-col items-center md:items-start space-y-4 md:space-y-2">
            <div className="flex items-center space-x-2">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FSADP-NEW-gduIlktO3FkSqqD7QqJCKbL1613fRX.png"
                alt="FSADP Logo"
                width={32}
                height={32}
                className="w-8 h-8"
          ...
          <div className="flex flex-col items-center md:items-end space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="text-white">
                ...
                <span className="text-gray-400 text-sm ml-1">(2,000+ reviews)</span>
              </div>
            </div>
          </div>
        </div>
