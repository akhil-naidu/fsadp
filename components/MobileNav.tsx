      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 bg-gray-900 border-b border-purple-600/20 py-2">
          <div className="container mx-auto px-4 flex flex-col gap-2">
            <a href="#" className="text-purple-600 hover:text-orange-500 transition-colors py-2">
              New Platform
            </a>
            <a href="#" className="text-gray-300 hover:text-orange-500 transition-colors py-2">
              MERN Stack Course
            </a>
            <a href="#" className="text-gray-300 hover:text-orange-500 transition-colors py-2">
              Placement Program
